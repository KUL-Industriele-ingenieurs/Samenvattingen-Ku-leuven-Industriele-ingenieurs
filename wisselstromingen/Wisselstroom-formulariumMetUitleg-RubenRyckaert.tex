...
\begin{align*}
    ...
    \theta &= \tan^{-1}\left(\frac{6}{5}\right) \approx 50.19°
\end{align*}

$$\vec{Z}_{\text{totaal}} \approx 7.81\angle{50.19°} \text{ } \Omega$$
...
Hoek: $\tan^{-1}\left(\frac{-0.215}{7.723}\right) \approx -1.59°$

$$\vec{Z}_{totaal} = 7.726\angle{-1.59°} \text{ } \Omega$$
...
\begin{enumerate}
    ...
    \item Zet bronlijnspanning om naar fasespanning (deel door $\sqrt{3}$, verschuif $-30°$)
...
De arbeidsfactor $0.7071$ komt overeen met $45°$, dus $\tan(45°) = 1$:
$$Q_3 = P_3 \times \tan(45°) = 8 \times 1 = 8 \text{ kVAR}$$
