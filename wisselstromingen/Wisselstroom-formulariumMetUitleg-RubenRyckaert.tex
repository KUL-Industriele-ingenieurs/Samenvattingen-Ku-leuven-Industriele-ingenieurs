...
\frm{Totale vermogen in 2-wattmethode}{P_{totaal} = \sqrt{3} V_L \cdot I_L \cos{\theta}
}{Met $P_{totaal}$ het totale actieve vermogen in Watt, $V_L$ de lijnspanning in Volt,
$I_L$ de lijnstroom in Ampère en $\theta$ de gemiddelde fasehoek tussen spanning en stroom van de belastingen in radialen.}
...
\frm{reactief vermogen in 2-wattmethode}{Q_{totaal} = \sqrt{3}(P_2 - P_1)
...
{Met $\theta$ de gemiddelde fasehoek tussen spanning en stroom van de belastingen in radialen, 
