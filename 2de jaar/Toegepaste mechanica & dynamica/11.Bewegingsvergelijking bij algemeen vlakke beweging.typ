...
#figure(
  image("assets/Statisch tot kinetisch.png", width: 5cm),
  caption: [Statisch tot kinetisch],
...
#frm[Kinetische wrijving][$F_(f k ) = mu_k * N$][waarbij $mu_k$ de wrijvingscoëfficiënt is en $N$ de normaalkracht.]
