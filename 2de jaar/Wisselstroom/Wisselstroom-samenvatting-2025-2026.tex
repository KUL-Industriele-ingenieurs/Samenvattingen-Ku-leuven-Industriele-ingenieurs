...
Het reactief vermogen kan je ook berekenen met de 2-wattmethode. Bij de standaard
aansluiting is $W_1$ de aflezing met $V_{ab}$ en $I_a$, en $W_2$ de aflezing met
$V_{cb}$ en $I_c$. Voor een \textbf{evenwichtige} belasting staat de stroomhoek bij
$W_1$ op $\theta+30^\circ$ en bij $W_2$ op $\theta-30^\circ$:
\[
W_1=V_LI_L\cos(\theta+30^\circ),\qquad
W_2=V_LI_L\cos(\theta-30^\circ)
\]
met: $W_1$ en $W_2$ = aflezingen van de wattmeters (W), $V_L$ = lijnspanning (V),
$I_L$ = lijnstroom (A) en $\theta$ = fasehoek van de belasting.

Het verschil van beide aflezingen geeft dan het reactief vermogen:
\[
Q_{totaal}=\sqrt{3}(W_2-W_1)=\sqrt{3}V_LI_L\sin\theta
\]
met: $Q_{totaal}$ = totaal reactief vermogen (var); een positieve waarde betekent
naijlend (inductief) en een negatieve waarde voorijlend (capacitief).
...
\begin{oefenblok}[Korte oefening: twee wattmeters]
    Een evenwichtige driefasenlast wordt gemeten met de standaard 2-wattmethode.
    De wattmeters lezen $W_1=0{,}60\ \text{kW}$ en $W_2=1{,}20\ \text{kW}$.
    Bepaal $P$, $Q$, $S$ en de arbeidsfactor.

    Eerst tellen we de twee wattmeteraflezingen op voor het actieve vermogen:
    \[
    P=W_1+W_2=0{,}60+1{,}20=\boxed{1{,}80\ \text{kW}}
    \]
    met: $P$ = totaal actief vermogen (kW), $W_1$ en $W_2$ = wattmeteraflezingen (kW).

    Daarna gebruiken we het verschil voor het reactieve vermogen:
    \[
    Q=\sqrt{3}(W_2-W_1)=\sqrt{3}(1{,}20-0{,}60)
      =\boxed{1{,}04\ \text{kvar}}
    \]
    met: $Q$ = totaal reactief vermogen (kvar).

    Het schijnbaar vermogen en de arbeidsfactor volgen uit de vermogensdriehoek:
    \[
    S=\sqrt{P^2+Q^2}=\sqrt{1{,}80^2+1{,}04^2}
      =\boxed{2{,}08\ \text{kVA}},\qquad
    \text{pf}=\frac{P}{S}=\boxed{0{,}866\ \text{naijlend}}
    \]
    met: $S$ = schijnbaar vermogen (kVA) en $\text{pf}$ = arbeidsfactor.
\end{oefenblok}

\frm{fasehoek}{\theta = tan^{-1}\left(\frac{Q_{totaal}}{P_{totaal}}\right)= tan^{-1}\left(\frac{\sqrt{3}(W_2 - W_1)}{W_1 + W_2}\right)
}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.40\textwidth]{assets/touch_voltage_curves_bb.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.52\textwidth]{assets/overcurrents_in_iz_ib.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth]{assets/mcb_bimetaal.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{assets/rcd_werking_extra.png}
