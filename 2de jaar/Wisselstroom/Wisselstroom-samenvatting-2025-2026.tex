...
\begin{center}
    ...
    \begin{tabular}{@{}p{34mm}p{50mm}p{50mm}@{}}
        \toprule
                                            & \textbf{\textcolor{schoolBlue}{Sterschakeling (Y)}}
                                            & \textbf{\textcolor{schoolBlue}{Driehoekschakeling ($\Delta$)}}                            \\
        \midrule
        \textbf{Herkennen aan}              & een gemeenschappelijk \textbf{sterpunt} $n$
                                            & een gesloten \textbf{lus}, geen sterpunt                                                  \\
        \textbf{Spanning over \'e\'en tak}  & $V_f = \dfrac{V_L}{\sqrt{3}}$
                                            & $V_f = V_L$ \quad \emph{(gelijk!)}                                                        \\
        \textbf{Stroom door \'e\'en tak}    & $I_f = I_L$ \quad \emph{(gelijk!)}
                                            & $I_f = \dfrac{I_L}{\sqrt{3}}$                                                             \\
        \textbf{Hoekverschuiving}           & $\underline{V}_L$ ijlt $30^\circ$ \textbf{voor} op $\underline{V}_f$
                                            & $\underline{I}_L$ ijlt $30^\circ$ \textbf{na} op $\underline{I}_f$                        \\
        \textbf{Wat is gegeven?}            & ``$3\times 400$~V'' betekent $V_L = 400$~V, dus $V_f = 230$~V
                                            & ``$3\times 400$~V'' betekent $V_f = V_L = 400$~V                                          \\
        \textbf{Stroom uit $Z$}             & $I_L = I_f = \dfrac{V_L}{\sqrt{3}\,Z}$
                                            & $I_L = \sqrt{3}\,I_f = \dfrac{\sqrt{3}\,V_L}{Z}$                                          \\
        \textbf{Vermogen in fasegrootheden} & \multicolumn{2}{c}{$P = 3\,V_f I_f \cos\varphi$ \quad --- \emph{geldt voor beide}}        \\
        \textbf{Vermogen in lijngrootheden} & \multicolumn{2}{c}{$P = \sqrt{3}\,V_L I_L \cos\varphi$ \quad --- \emph{geldt voor beide}} \\
        \textbf{Vermogen uit $V_L$ en $Z$}  & $P = \dfrac{V_L^2}{Z}\cos\varphi$
                                            & $P = 3\,\dfrac{V_L^2}{Z}\cos\varphi$ \quad (dus $3\times$ zoveel)                         \\
        \bottomrule
    \end{tabular}
\end{center}
