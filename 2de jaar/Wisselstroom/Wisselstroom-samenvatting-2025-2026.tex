...
\begin{examenbox}[Amplitude of effectieve waarde?]
    Een fasor kan je met de \textbf{amplitude} $A_m$ of met de \textbf{effectieve waarde} / RMS-waarde $A_{rms}$.
...
\concept{Impedantie \& Reluctantie}[
    \textbf{De impedantie} is een ander woord voor weerstand waarbij we het complex deel ook meenemen.
    De \textbf{reluctantie} is dat complexe deel en is veroorzaakt door een spoel $L$ of condensator $C$.

    Impedantie = weerstand + j $\cdot$ reactantie
...
Het schijnbaar vermogen is de som van het actieve vermogen $P$ en het reactief vermogen $Q$.
Het is het vermogen dat de bron moet leveren, maar dat niet allemaal nuttig wordt gebruikt.
...
$$ P + jQ = V_{rms} I_{rms} \angle \phi = S \angle \phi $$
