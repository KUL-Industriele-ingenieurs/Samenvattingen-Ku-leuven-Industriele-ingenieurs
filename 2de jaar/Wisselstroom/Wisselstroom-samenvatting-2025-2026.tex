...
\begin{waarschuwing}[Voorbehoud]
    Deze lijst komt van het studforum en hoort bij het \textbf{oude lesprogramma} (van vóór de
...
\begin{examenbox}[Amplitude of effectieve waarde?]
    ...
    $A_{rms} = A_m/\sqrt{2}$ schrijven. Beide mag, zolang je \textbf{consequent} bent.
...
We beginnen met het eenvoudigste geval: een \textbf{zuiver ohmse} belasting, waarbij spanning
...
Twee dingen vallen op. Het \textbf{gemiddelde} van $p(t)$ is $V_{rms}I_{rms}$, want de cosinusterm
...
referentie: reken gewoon van daaruit naar voor, zonder schaalstap.
...
\begin{examenbox}[EXAMENVRAAG: De 5 Gouden Regels]
    \begin{enumerate}
        \item \textbf{Volledig uitschakelen en scheiden (Disconnect):} alle polen en alle mogelijke
              voedingsbronnen (inclusief noodstroomaggregaten, PV-omvormers en condensatorbatterijen) scheiden.
        \item \textbf{Beveiligen tegen herinschakeling (Lockout/Tagout):} schakelaars mechanisch vergrendelen
              met een hangslot en voorzien van een waarschuwingslabel.
        \item \textbf{Spanningsloosheid controleren (Verify zero voltage):} meten met een goedgekeurde
              tweepolige spanningsaanwijzer. \textbf{Controleer het meettoestel altijd vlak vóór én vlak
                  na de meting op een gekende spanningsbron!}
        \item \textbf{Aarden en kortsluiten (Earth and short-circuit):} de geleiders onderling en met de aarde
              verbinden (verplicht bij hoogspanning, aanbevolen bij laagspanning) om inductieve en capacitieve
              restspanningen af te voeren.
        \item \textbf{Afschermen en afbakenen (Protect and delineate):} nabijgelegen delen die nog onder
