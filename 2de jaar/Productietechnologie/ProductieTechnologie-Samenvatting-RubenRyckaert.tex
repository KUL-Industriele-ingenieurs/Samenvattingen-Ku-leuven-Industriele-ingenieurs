...
\smallskip
\noindent\textbf{Praktische opmerking.}
Dit is een ideale, geometrische ondergrens. In de praktijk verhogen trillingen, BUE en slijtage de gemeten waarden — gebruik de formules voor schattingen en parametervergelijkingen, niet als absolute garanties.
...
\textbf{Voeding per tand bij Frezen:} $f_z = \dfrac{f}{z_i}$\\\small
\newline
waarbij $f$ de voeding is en $z_i$ het aantal tanden van de frees.

\textbf{Snijsnelheid bij Frezen:} $v_c = \pi \cdot d \cdot n$\\\small
\newline
waarbij $d$ de diameter van de frees is en $n$ het toerental.

\textbf{Ingrijpingshoek bij Frezen:} $\displaystyle \phi = \arccos\!\left(1 - \dfrac{2a}{d}\right) \;\Rightarrow\; \cos\phi = 1 - \dfrac{2a}{d}$.\\\small
\newline
