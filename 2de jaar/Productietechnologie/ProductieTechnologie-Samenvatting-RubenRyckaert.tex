...
\begin{wrapfigure}[15]{r}{0.4\textwidth}
	\centering
	\includegraphics[width=\linewidth]{nominalematen.png}
...
\frm{Snijsnelheid}{v = \pi \cdot d \cdot n}
{waarbij $v$ de snijsnelheid is [\si{m/min}], $d$ de diameter [\si{mm}] en $n$ het toerental [\si{omw/min}].}
