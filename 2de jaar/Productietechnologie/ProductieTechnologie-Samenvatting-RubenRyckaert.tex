...
\begin{conceptbox}[title=Volgorde voor precisiegaten]
...
\begin{conceptbox}[title=Onbepaalde snijkant]
    In tegenstelling tot draaien of frezen, heeft slijpen geen vaste snijkantgeometrie. Het oppervlak van de slijpsteen bestaat uit ontelbare, 
	willekeurig georiënteerde korrels die materiaal afnemen met een sterk negatieve spaanhoek.
\end{conceptbox}
...
\begin{conceptbox}[title=Soorten zandbinding]
	\begin{itemize}
...
\begin{conceptbox}[title=Design for Manufacturing (DFM) VS Manufacturing for Design (MFD)]
