...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.4\textwidth]{nominalematen.png}
...
\begin{conceptbox}[IT-klasse]
	\textbf{De IT-klasse (International Tolerance grade)} geeft de nauwkeurigheid van een maat aan. Hoe lager het IT-nummer, hoe strakker de tolerantie.
	\newline 
\end{conceptbox}
...
\begin{figure}[ht]
	...
	\includegraphics[width=0.45\textwidth]{image2.png}\hfill
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{image86.png}
...
\begin{enumerate}
	...
	\item \textbf{Slijtage}
		...
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=0.40\textwidth]{image23.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.4\textwidth]{hellingshoek.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=1\textwidth]{image40.png}
...
\begin{wrapfigure}[15]{r}{0.53\textwidth}
	\centering
	\includegraphics[width=\linewidth]{borenhoeken.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\textwidth]{image48.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\textwidth]{image59.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.65\textwidth]{image60.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.4\textwidth]{image70.png}
	\caption{}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.4\textwidth]{image75.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.26\textwidth]{image73.png}
...
\begin{wrapfigure}[12]{r}{0.4\textwidth}
	\centering
	\includegraphics[width=\linewidth]{image74.png}
...
\begin{wrapfigure}[12]{r}{0.52\textwidth}
	\centering
	\includegraphics[width=\linewidth]{Reflecteren in functie van de golflengte.png}
	\caption{}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.6\textwidth]{Absorptie van polycarbonaat.png}
	\caption{}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=1\textwidth]{NC-lasers.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.55\textwidth]{image80.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{Fijnsnijden.png}
    \caption{}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\textwidth]{Tabel van soorten legeringen die gegoten worden.png}
...
\begin{conceptbox}[Volumevermindering bij stollen]
	Volumevermindering door stollen noemt men \belangrijk{Slink}. Een slink is een microscopisch gaatje in het gietstuk dat ontstaat tijdens het stollen 
	en wordt gecompenseerd door opkomers. Opkomers zijn openingen in de gietvorm, Je giet meer 
	metaal in de opkomer zodat het krimpend metaal in het gietstuk aangevuld wordt. Dit compenseert de volumevermindering tijdens het stollen.\\
...
\begin{figure}[htbp]
	...
	\begin{minipage}[b]{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Zandgieten.png}
	\end{minipage}\hfill
	\begin{minipage}[b]{0.48\textwidth}
		\centering
		\begin{tikzpicture}[node distance=1.6cm, auto,
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{Autozandvormen.png}
...
\begin{wrapfigure}[23]{r}{0.4\textwidth}
	\centering
	\includegraphics[width=0.9\linewidth]{verlorenwasgieten.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\textwidth]{kenmerkeneneisenmachines.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.55\textwidth]{image85.png}
...
De keuze voor een productiesysteem wordt bepaald door de balans tussen de \textbf{seriegrootte} en de \textbf{moeilijkheidsgraad} (of het afkeurrisico) van het product. 
In de onderstaande grafiek (vaak ook de K-grafiek genoemd in deze context) zien we hoe verschillende technologieën zich tot elkaar verhouden.
...
De evolutie in de technologie (weergegeven door de verschuiving van de gestreepte naar de doorgetrokken lijnen) laat zien dat NC-machines een steeds groter gebied bestrijken. 
Ze worden rendabeler bij zowel kleinere series (door kortere insteltijden) als grotere series (door hogere productiviteit), en kunnen steeds complexere taken aan.
...
\begin{wrapfigure}[16]{r}{0.3\textwidth}
    ...
    \includegraphics[width=\linewidth]{WorkflowCADCAM.png}
...
Je moet duidelijk weten wat mogelijk is en wat de beperkingen zijn. De kosten van deze processen moeten ook in rekening worden gebracht. Bij het opstellen van een bewerkingsplan is er vaak niet één enkel correct antwoord; verschillende keuzes kunnen verdedigbaar zijn, 
zolang ze goed gemotiveerd worden op basis van factoren zoals de vereiste accuraatheid, de kostprijs, de productiesnelheid en de serie-grootte.
...
Bij het positioneren wordt het werkstuk nauwkeurig in de machine geplaatst ten opzichte van een gekozen nulpunt of referentievlak. Het doel is om het werkstuk eenduidig vast te leggen in de ruimte, 
zodat de machine exact weet waar de bewerkingen moeten plaatsvinden. Hiervoor moet men vaak eerst een referentievlak bepalen door het werkstuk op te meten.

\begin{figure}[htbp]
	\centering 
	\includegraphics[width=0.2\textwidth]{positioneren.png}
...
\autofig[0.3\textwidth]{image82.png}
{Klemmen van het werkstuk: diverse methoden om het werkstuk stabiel te fixeren tijdens de bewerking.}

\subsection{Ondersteuning}

Naast positionering en klemmen is ondersteuning cruciaal, zeker bij complexe of minder stijve werkstukken. 
Ondersteuning dient niet enkel om het eigen gewicht van het stuk te dragen, 
maar vooral om vervorming door de grote snijkrachten tegen te gaan. 
...
\autofig[0.4\textwidth]{voorkomenbuiging.png}{Ondersteuning van het werkstuk: het gebruik van steunpunten om doorbuiging en trillingen tijdens de bewerking te minimaliseren.}
...
\autofig[0.6\textwidth]{universeeltegenspecifiek.png}{Universeel klemmen versus productspecifiek klemmen: flexibele modulaire systemen versus op maat gemaakte mallen.}
...
\end{examenbox}
	...
	\begin{center}
		\includegraphics[width=0.65\textwidth]{image84.png}
...
\autofig[0.55\textwidth]
{gemaaktEnVastgelegdeKosten.png}{Gerealiseerde versus vastgelegde kosten: Hoewel de ontwerpfase zelf relatief weinig kost, wordt hier het grootste deel van de uiteindelijke productiekosten vastgelegd.}
...
\autofig[0.6\textwidth]{designenvoortoeslagen.png}{Designen voor toeslagen: Het voorzien van voldoende bewerkingstoegift en
 toegankelijkheid voor gereedschappen.}
