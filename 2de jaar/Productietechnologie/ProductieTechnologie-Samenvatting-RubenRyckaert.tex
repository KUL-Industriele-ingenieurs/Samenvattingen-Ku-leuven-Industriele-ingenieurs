...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{nominalematen.png}
  \caption{Nominale maten met boven- en ondergrens.}
  \label{fig:nominalematen.png}
 \end{figure}

 De toleratie maat bereken je met de buiten en binnenmaat:

 \frm{Tolerantie}{T = Buitenkant - Binnenkant}{waarbij $T$ de tolerantie is [\si{mm}], $Buitenkant$ de maximale maat [\si{mm}] en $Binnenkant$ de minimale maat [\si{mm}].}
...
\begin{itemize}
	...
	\item Snedebreedte $b$ (hoe breed de beitel is)
...
van het werkstuk.
De grootte van de spanen wordt bepaald \textbf{door de snedediepte, de voeding, 
de spaanhoek en de wrijvingscoëfficiënt.\ldots} Zometeen meer in detail hierover
...
\begin{description}
	\item[Continue:] Bij ductiele materialen en scherpe beitels. Goede oppervlaktekwaliteit.
	\item[lamellen:] Bij hogere snededieptes of hardere materialen. Spaan breekt in dunne lagen.
	\item[brokkelspannen:] Bij brosse materialen. Spaan breekt in kleine brokstukken.
\end{description}
...
\frm{h: snededikte bij draaien}{h = f \cdot \sin X}{met $h$ de snededikte [\si{mm}], $f$ de voeding [\si{mm/omw}] en $X$ de instelhoek [$^\circ$].}
...
\begin{enumerate}
	...
	\item \textbf{Snijkanthoek $X$}: Het veranderen van de hoek van het snijvlak verschuift de richting en verdeling van de krachten. 
...
hetwerkstuk en het afschuifvalk, de afschuifvlak is het oppervlakte waar er plastische vervorming is.} 
...
\begin{conceptbox}[Volumevermindering bij stollen]
	Volumevermindering door stollen noemt men \belangrijk{Slink}. Een slink is een microscopisch gaatje in het gietstuk dat ontstaat tijdens het stollen en wordt gecompenseerd door opkomers.
...
Je maakt je CAD, je importeert in CAM, je genereert G-code en je stuurt dit naar de machine via een netwerk. 
