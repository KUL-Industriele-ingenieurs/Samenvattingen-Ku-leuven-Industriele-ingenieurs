...
#figure(
  image("assets/OIS_stuurkast_deurbedrading.png", width: 100%),
...
De terminal marking vind je terug bij componenten zoals motoren:

#table(
  columns: 4,
  align: left,
  table.header([*Designated conductor*], [*Potential*], [*Terminal marking*], [*Symbool*]),
  [Protective earth], [PE], [PE], [aardsymbool],
  [AC conductor --- fase 1], [L1], [U], [---],
  [AC conductor --- fase 2], [L2], [V], [---],
  [AC conductor --- fase 3], [L3], [W], [---],
)
