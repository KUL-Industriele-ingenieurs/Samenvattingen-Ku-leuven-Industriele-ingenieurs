...
\subsection{HOOFDSTUK 3 (p.$\sim$130): Ichneumon Wasps}
...
\subsection{HOOFDSTUK 4 (p.$\sim$192): Metafysische Ambiguïteit}
...
\subsection{HOOFDSTUK 5 (§5.3, p.$\sim$165--180): Welcome to the Anthropocene / Spirituele Uitdaging}
...
\subsection{HOOFDSTUK 7 (§7.1, §7.2.3, p.$\sim$273--310): Aardse Systeemwetenschap als Spirituele Bron}
...
As an engineer, the course has permanently changed how I think about my profession. The Bah\'a'\'i\xspace insight -- that work can be a form of service/worship -- and the Christian notion of ``created co-creators'' (Hefner) both suggest that engineering is never morally neutral. Every bridge, every circuit board, every algorithm participates in a broader vision of what humanity is for.
\end{answerbox}
