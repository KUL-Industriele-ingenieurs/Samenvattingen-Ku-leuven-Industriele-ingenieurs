...
\begin{enumerate}
    \item \concept{Behoeften, Wensen en Vraag}: Het vertrekpunt is de \textbf{maatschappij},
     ...
     Als deze wensen gesteund worden door koopkracht, ontstaat er een concrete \textbf{vraag}.
    ...
    \item \concept{Waarde en Tevredenheid}: De consument maakt een keuze op basis van de verwachte waarde. 
    De \textbf{tevredenheid} achteraf hangt af van de waargenomen prestaties ten opzichte van de verwachtingen. Kwaliteit speelt hierin een sleutelrol.
    \item \concept{Ruil, Transactie en Relaties}: Een \textbf{ruil} is de kern van marketing: het verkrijgen 
    van een gewenst object door iets terug te geven (meestal geld). Een \textbf{transactie} is een ruil met meetbare waarden. Succesvolle transacties bouwen langdurige \textbf{relaties} op met klanten.
...
\begin{description}
    ...
    \item[Verantwoordelijkheid binnen de organisatie]
     Wat voor soort bedrijf ben je. Non-profit of winstgericht?
...
Maar omdat we de optimale oplossing zoeken en $X_1$ niet in de basis zit, \textbf{kiezen} we ervoor om $X_1 = 0$ te stellen.

\textit{Regel 3: De Z-rij vertelt of dit optimaal is}

De coëfficiënt van $X_1$ in de Z-rij is $+3$ (positief). Dit betekent: als we $X_1$ in de basis zouden brengen, zou de winstfunctie \textbf{dalen} met 3 per eenheid. Daarom is het beter om $X_1 = 0$ te houden.
