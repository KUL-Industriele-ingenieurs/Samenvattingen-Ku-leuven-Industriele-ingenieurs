...
\begin{minipage}[t]{0.58\textwidth}
\vspace{0pt}
Interest die wordt verdiend op zowel het oorspronkelijke bedrag als op de eerder verdiende interest. Je krijgt dus een "rente op rente" effect. Dit leidt tot exponentiële groei van investeringen over tijd.
\end{minipage}%
\hfill
...
\addplot[blue, thick, domain=0:10, samples=50] {100*(1.05)^x};
\addlegendentry{Compound (5\%)}
\addplot[red, dashed, domain=0:10] {100 + 5*x};
\addlegendentry{Simpel (5\%)}
\end{axis}
\end{tikzpicture}
\end{minipage}
...
\begin{axis}[
    ...
    tick label style={font=\tiny},
    xtick={1,2},
    xticklabels={Investering A, Investering B},
    ybar,
    bar width=20pt,
    nodes near coords,
    every node near coord/.append style={font=\small}
]
\addplot[fill=green!60] coordinates {(1,120) (2,150)};
\end{axis}
\end{tikzpicture}
\end{minipage}
